...
const u32 gMonStillFrontPic_Wobbigget[] = INCBIN_U32("graphics/pokemon/wobbigget/front.4bpp.lz");
const u32 gMonPalette_Wobbigget[] = INCBIN_U32("graphics/pokemon/wobbigget/normal.gbapal.lz");
const u32 gMonBackPic_Wobbigget[] = INCBIN_U32("graphics/pokemon/wobbigget/back.4bpp.lz");
const u32 gMonShinyPalette_Wobbigget[] = INCBIN_U32("graphics/pokemon/wobbigget/shiny.gbapal.lz");
const u8 gMonIcon_Wobbigget[] = INCBIN_U8("graphics/pokemon/wobbigget/icon.4bpp");
const u8 gMonFootprint_Wobbigget[] = INCBIN_U8("graphics/pokemon/wobbigget/footprint.1bpp");
